...
def alphamissense_predictions_agent(state: "State") -> "State":
    ...
    pathogenicity_class_df = pd.read_csv('local_dbs/AlphaMissense_hg38.tsv', skiprows=4, names = ['chrom', 'pos', 'ref', 'alt', 'genome', 'uniprot_id', 'transcript_id', 'protein_variant', 'am_pathogenicity', 'am_class'], sep = '\t')
