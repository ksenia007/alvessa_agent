...
from src.config import DEBUG, DBSNP_DEFAULT_ASSEMBLY
from src.state import State
from .query import get_variant_info
...
NODES: tuple[Node, ...] = (
    Node(
        ...
        entry_point=dbsnp_variants_agent,
        description=(
            "Annotate existing variants with dbSNP coordinates and context required by downstream nodes."
        ),
    ),
    Node(
